...
+-----------------------------------------------------------------------------------------------------------------------------+
| Name  : fifolock                                                                                                            |
| Info  : A flexible low-level tool to make synchronisation primitives in asyncio Python.                                     |
|         As the name suggests, locks are granted strictly in the order requested: first-in-first-out; and are not reentrant. |
|-----------------------------------------------------------------------------------------------------------------------------|
| Author: michalc                                                                                                             |
| GitHub: https://github.com/michalc/fifolock                                                                                 |
+-----------------------------------------------------------------------------------------------------------------------------+
'''
