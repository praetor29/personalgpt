...
with open(os.path.join('training', 'character_training.txt'), 'r', encoding='utf-8') as file:
    character_training = file.readlines()

conversation_history = " ".join(character_training)
...
You should also take inspiration from the following conversation history in crafting your responses:
